...
- [inmanta-docker](#inmanta-docker)
  ...
  - [Examples](#examples)
    ...
    - [Deploy the orchestrator with a logrotate sidecar](#deploy-the-orchestrator-with-a-logrotate-sidecar)
...
| `INMANTA_ORCHESTRATOR_LOGROTATE_IMAGE` | `ghcr.io/inmanta/orchestrator-logrotate:latest` | all | This environment variable specifies which container image tag the logrotate container should bear. |
...
```bash
echo "INMANTA_ORCHESTRATOR_IMAGE=..." >> .env
echo "INMANTA_ORCHESTRATOR_LOGROTATE_IMAGE=..." >> .env
